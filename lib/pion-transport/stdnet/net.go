...
func (z *ZitiPacketConn) SetDeadline(t time.Time) error {
	return z.zitiCon.SetDeadline(t)
}

func (z *ZitiPacketConn) SetReadDeadline(t time.Time) error {
	return z.zitiCon.SetReadDeadline(t)
}
