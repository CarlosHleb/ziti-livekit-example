...
replace github.com/livekit/protocol v1.19.4-0.20240808180722-581b59b65309 => ../livekit-protocol

replace github.com/pion/webrtc/v3 v3.2.50 => ../pion-webrtc

replace github.com/pion/ice/v2 v2.3.31 => ../pion-ice

replace github.com/pion/transport/v2 v2.2.8 => ../pion-transport

replace github.com/pion/turn/v2 v2.1.6 => ../pion-turn
